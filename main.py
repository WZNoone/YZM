...
train_path = r'D:\S\yzm\Mark\train_all'

test_path = r'D:\S\yzm\Mark\6ori'
...
if __name__ == '__main__':
    ...
    # # 加载前几层的参数
    # pretrained_dict = {k: v for k, v in checkpoint.items() if k.split('.')[0] in ['conv1', 'conv2', 'conv3']}
    # new_model_state_dict = model.state_dict()

    # # 更新模型的状态字典
    # new_model_state_dict.update(pretrained_dict)
    # # 加载更新后的状态字典
